create or replace PACKAGE  FIDE_CLINICA_DENTAL_PROCEDURES_PKG AS
    ...
    V_ID_USUARIO IN NUMBER, V_ID_ROLE IN NUMBER);
    ...
    PROCEDURE USUARIO_EDITAR_SEGUNDO_APELLIDO_SP(V_ID_USUARIO IN VARCHAR2,
    V_SEGUNDO_APELLIDO IN VARCHAR2);
    
    PROCEDURE USUARIO_EDITAR_TELEFONO_SP(V_TELEFONO IN NUMBER,V_ID_USUARIO IN NUMBER);  
    PROCEDURE CITA_CREACTION_CITA_SP(V_ID_USUARIO IN NUMBER,V_ID_DOCTOR IN NUMBER,
    V_FECHA IN DATE,V_ID_SERVICIO IN VARCHAR2,V_HORA IN DATE, V_ID_CONSULTORIO IN NUMBER);
