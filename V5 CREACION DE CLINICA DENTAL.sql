...
------ESTADO-------
CREATE SEQUENCE DENT_ESTADO_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_ESTADO
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_ESTADO_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_ESTADO FROM DUAL;
-----------------
------ROLE-------
CREATE SEQUENCE DENT_ROLE_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_ROLE
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_ROLE_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_ROLE FROM DUAL;
-----------------
------ALMACEN-------
CREATE SEQUENCE DENT_ALMACEN_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_ALMACEN
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_ALMACEN_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_ALMACEN FROM DUAL;
-----------------
------USUARIO-------
CREATE SEQUENCE DENT_USUARIO_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_USUARIO
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO :=  DENT_USUARIO_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_USUARIO FROM DUAL;
-----------------
------DOCTORES-------
CREATE SEQUENCE DENT_DOCTORES_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_DOCTORES
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO :=  DENT_DOCTORES_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_DOCTORES FROM DUAL;
-----------------
------CITA-------
...
CREATE OR REPLACE FUNCTION SECUENCIA_DENT_CITAS
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_CITAS_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_CITAS FROM DUAL;
-----------------
------SERVICIOS-------
...
CREATE OR REPLACE FUNCTION SECUENCIA_DENT_SERVICIOS
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_SERVICIOS_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_SERVICIOS FROM DUAL;
-----------------
------SERVICIOS-------
CREATE SEQUENCE DENT_CONSULTORIO_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_CONSULTORIO
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_CONSULTORIO_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_CONSULTORIO FROM DUAL;
-----------------
------ENTIDAD BANCARIA-------
CREATE SEQUENCE DENT_ENTIDAD_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_ENTIDAD
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_ENTIDAD_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_ENTIDAD FROM DUAL;
-----------------
------ENTIDAD BANCARIA-------
CREATE SEQUENCE DENT_PROVINCIA_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_PROVINCIA
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_PROVINCIA_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_PROVINCIA FROM DUAL;
-----------------

------INVENTARIO-------
CREATE SEQUENCE DENT_INVENTARIO_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_INVENTARIO
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_INVENTARIO_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_INVENTARIO FROM DUAL;
-----------------

------RECETAS-------
CREATE SEQUENCE DENT_RECETAS_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_RECETAS
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_RECETAS_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_RECETAS FROM DUAL;
-----------------

------DETALLE FACTURA-------
CREATE SEQUENCE DENT_DETALLE_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_DETALLE
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_DETALLE_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;

SELECT SECUENCIA_DENT_DETALLE FROM DUAL;
-----------------

------FACTURAS-------
CREATE SEQUENCE DENT_FACTURA_SQ
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE FUNCTION SECUENCIA_DENT_FACTURA
RETURN VARCHAR2
IS 
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := DENT_FACTURA_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
--ALMACEN--
CREATE OR REPLACE TRIGGER  ALMANCEN_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_ALMACEN_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--CANTON--
CREATE OR REPLACE TRIGGER  CANTON_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_CANTON_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--CITAS--
CREATE OR REPLACE TRIGGER  CITAS_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_CITAS_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--CONSULTORIO--
CREATE OR REPLACE TRIGGER  CONSULTORIO_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_CONSULTORIO_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--DETALLE--
CREATE OR REPLACE TRIGGER  DETALLE_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_DETALLE_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--DISTRITO--
CREATE OR REPLACE TRIGGER  DISTRITO_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_DISTRITO_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--DOCTORES--
CREATE OR REPLACE TRIGGER  DOCTORES_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_DOCTORES_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--ENTIDAD BANCARIA--
CREATE OR REPLACE TRIGGER  ENTIDAD_BANCARIA_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_ENTIDAD_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--ESTADO--
CREATE OR REPLACE TRIGGER  ESTADO_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_ESTADO_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--FACTURA--
CREATE OR REPLACE TRIGGER  FACTURA_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_FACTURA_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--INVENTARIO--
CREATE OR REPLACE TRIGGER  INVENTARIO_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_INVENTARIO_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--METODO PAGO--
CREATE OR REPLACE TRIGGER  METODO_PAGO_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_METODO_PAGO_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--PROVEEDORES--
CREATE OR REPLACE TRIGGER  PROVEEDORES_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_PROVEEDORES_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--PROVINCIA--
CREATE OR REPLACE TRIGGER  PROVINCIA_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_PROVINCIA_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--RECETAS--
CREATE OR REPLACE TRIGGER  RECETAS_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_RECETAS_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--ROLE--
CREATE OR REPLACE TRIGGER  ROLE_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_ROLE
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--SERVICIOS--
CREATE OR REPLACE TRIGGER  SERVICIOS_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_SERVICIOS_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
...
--USUARIO--
CREATE OR REPLACE TRIGGER  USUARIO_CREADO_MODIFICADO_POR
BEFORE INSERT OR UPDATE ON  DENT_USUARIO_TB
FOR EACH ROW 
BEGIN
    IF INSERTING THEN
        :NEW.CREADO_POR:= USER;
