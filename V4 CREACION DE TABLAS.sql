...
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_ESTADO_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_ROLE_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_ALMACEN_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_USUARIO_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_DOCTORES_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_CITAS_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_SERVICIOS_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_CONSULTORIO_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_ENTIDAD_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_PROVINCIA_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_INVENTARIO_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'|| DENT_RECETAS_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'||DENT_DETALLE_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
...
V_RESULTADO VARCHAR2(100);
BEGIN 
V_RESULTADO := TO_CHAR(SYSDATE,'DD-MM-YYYY')||'-'||DENT_FACTURA_SQ.NEXTVAL;
RETURN V_RESULTADO;                              
END;
