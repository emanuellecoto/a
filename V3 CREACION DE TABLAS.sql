...
ACCION VARCHAR2(100),
  ...
  REFERENCES DENT_ALMACEN_TB(ID_ALMACEN)
...
ACCION VARCHAR2(100),
  ...
  CONSTRAINT DETALLE_ID_FACTURA_FK
  FOREIGN KEY(ID_FACTURA)
  REFERENCES DENT_FACTURA_TB(ID_FACTURA),
...
ACCION VARCHAR2(100),
  ...
  REFERENCES DENT_METODO_PAGO_TB(ID_METODO_PAGO),
...
CREATE TABLE DENT_CITAS_TB (
  ID_CITA NUMBER CONSTRAINT DENT_ID_CITA_PK  PRIMARY KEY, 
  ID_USUARIO NUMBER, 
  ID_DOCTOR NUMBER, 
  FECHA DATE, 
  ID_SERVICIO NUMBER, 
...
CREATE TABLE DENT_METODO_PAGO_TB (
  ID_METODO NUMBER CONSTRAINT DENT_ID_METODO_PK PRIMARY KEY,
...
ACCION VARCHAR2(100),
  ID_ESTADO VARCHAR2(1),
    ...
    CONSTRAINT METODO_ID_ESTADO_FK
    FOREIGN KEY(ID_ESTADO)
    REFERENCES DENT_ESTADO_TB(ID_ESTADO), 
    
    CONSTRAINT METODO_ID_ENTIDAD_BANCARIA_FK
