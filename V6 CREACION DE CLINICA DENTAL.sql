...
ALTER TABLE FIDE_ESTADO_TB ADD ESTADO VARCHAR2(100);
ALTER TABLE FIDE_ESTADO_TB MODIFY (DESCRIPCION VARCHAR2(100));
...
CREATE OR REPLACE TRIGGER FIDE_CITA_FECHA_CREACION_TRG
BEFORE UPDATE OR INSERT ON FIDE_CITAS_TB
FOR EACH ROW 
    BEGIN 
        IF INSERTING THEN 
...
CREATE OR REPLACE TRIGGER FIDE_CITA_ESTADO_POR_TRG
BEFORE INSERT OR UPDATE ON FIDE_CITAS_TB
FOR EACH ROW 
    BEGIN 
        :NEW.ID_ESTADO := 1;
